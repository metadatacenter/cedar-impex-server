...
public class ImpexServerApplicationSmokeTest {
  ...
  @ClassRule
  public static final DropwizardAppRule<ImpexServerConfiguration> SERVER =
      new DropwizardAppRule<>(ImpexServerApplication.class, ResourceHelpers.resourceFilePath("test-config.yml"));
