...
import org.metadatacenter.impex.CEDARValidationResponse;
import org.metadatacenter.impex.ncbi.pipelines.NcbiPipelinesCommonUtil;
import org.metadatacenter.impex.ncbi.pipelines.NcbiPipelinesCommonValidator;
...
public class NcbiGenericValidator {
  ...
  public CEDARValidationResponse validateInstance(JsonNode instance) {
    ...
    messages.addAll(NcbiPipelinesCommonValidator.validateBiosampleSraRefs(biosamples.get(), sras.get(),
        BIOSAMPLE_SAMPLE_NAME_FIELD, SRA_SAMPLE_NAME_FIELD));
